(() => {
  ...
  const messages = {
    ko: {
      ...
      'home.uranus.title': '천왕성 멍',
      'home.uranus.desc': '차갑고 옅은 청록빛이 감도는 얼음 행성',
      'home.neptune.title': '해왕성 멍',
      'home.neptune.desc': '짙고 깊은 푸른빛이 느리게 흐르는 얼음 행성',
      ...
      'pages.sun.loading': '태양 8K 로딩 중... ',
      'pages.sun.error': '로딩 실패... 새로고침 후 다시 시도해 주세요',
      'pages.mars.title': '화성',
      'pages.mars.loading': '화성 로딩 중...',
      'pages.venus.title': '금성',
      'pages.venus.info': '금성 · 두꺼운 대기 속에 밀폐된 주황빛 행성',
      'pages.jupiter.title': '목성',
      'pages.jupiter.info': '목성',
      'pages.saturn.title': '토성',
      'pages.saturn.info': '토성',
      'pages.uranus.title': '천왕성',
      'pages.uranus.info': '천왕성 · 차갑고 옅은 청록빛이 감도는 얼음 행성',
      'pages.neptune.title': '해왕성',
      'pages.neptune.info': '해왕성 · 짙고 깊은 푸른빛이 느리게 흐르는 얼음 행성',
    ...
    en: {
      ...
      'home.uranus.title': 'Uranus Drift',
      'home.uranus.desc': 'A cold ice giant with a pale teal glow',
      'home.neptune.title': 'Neptune Drift',
      'home.neptune.desc': 'A deep blue ice giant with slow moving tones',
      ...
      'pages.sun.title': 'Sun',
      'pages.sun.loading': 'Loading 8K sun...',
      ...
      'pages.venus.info': 'Venus · A sealed orange world under thick clouds',
      'pages.jupiter.title': 'Jupiter',
      'pages.jupiter.info': 'Jupiter',
      'pages.saturn.title': 'Saturn',
      'pages.saturn.info': 'Saturn',
      'pages.uranus.title': 'Uranus',
      'pages.uranus.info': 'Uranus · A cold ice giant with a pale teal glow',
      'pages.neptune.title': 'Neptune',
      'pages.neptune.info': 'Neptune · A deep blue ice giant with slow moving tones',
    ...
    fr: {
      ...
      'home.uranus.title': 'Pause Uranus',
      'home.uranus.desc': 'Une geante de glace froide a l eclat turquoise pale',
      'home.neptune.title': 'Pause Neptune',
      'home.neptune.desc': 'Une geante de glace bleue profonde aux teintes lentes',
      ...
      'pages.sun.loading': 'Chargement de la solaire 8K...',
      'pages.sun.error': 'Echec du chargement. Recharge puis reessaie.',
      'pages.mars.title': 'Mars',
      'pages.mars.loading': 'Chargement de Mars...',
      'pages.venus.title': 'Venus',
      'pages.venus.info': 'Venus · Une planete orange enfermee sous une atmosphere dense',
      'pages.jupiter.title': 'Jupiter',
      'pages.jupiter.info': 'Jupiter',
      'pages.saturn.title': 'Saturne',
      'pages.saturn.info': 'Saturne',
      'pages.uranus.title': 'Uranus',
      'pages.uranus.info': 'Uranus · Une geante de glace froide a l eclat turquoise pale',
      'pages.neptune.title': 'Neptune',
      'pages.neptune.info': 'Neptune · Une geante de glace bleue profonde aux teintes lentes',
    ...
    de: {
      ...
      'home.uranus.title': 'Uranus Pause',
      'home.uranus.desc': 'Ein kalter Eisriese mit blass turkisem Schimmer',
      'home.neptune.title': 'Neptun Pause',
      'home.neptune.desc': 'Ein tiefblauer Eisriese mit langsam fliessenden Tonen',
      ...
      'pages.sun.loading': '8K Sonnen wird geladen...',
      'pages.sun.error': 'Laden fehlgeschlagen. Bitte neu laden und erneut versuchen.',
      'pages.mars.title': 'Mars',
      'pages.mars.loading': 'Mars wird geladen...',
      'pages.venus.title': 'Venus',
      'pages.venus.info': 'Venus · Ein orangefarbener Planet unter dichter Atmosphare',
      'pages.jupiter.title': 'Jupiter',
      'pages.jupiter.info': 'Jupiter',
      'pages.saturn.title': 'Saturn',
      'pages.saturn.info': 'Saturn',
      'pages.uranus.title': 'Uranus',
      'pages.uranus.info': 'Uranus · Ein kalter Eisriese mit blass turkisem Schimmer',
      'pages.neptune.title': 'Neptun',
      'pages.neptune.info': 'Neptun · Ein tiefblauer Eisriese mit langsam fliessenden Tonen',
    ...
    ja: {
      ...
      'home.uranus.title': '天王星ぼーっと',
      'home.uranus.desc': '淡い青緑の光をまとった冷たい氷惑星',
      'home.neptune.title': '海王星ぼーっと',
      'home.neptune.desc': '深い青がゆっくり流れる氷惑星',
      ...
      'pages.sun.title': '太陽',
      'pages.sun.loading': '8K太陽テクスチャを読み込み中...',
      'pages.sun.error': '読み込みに失敗しました。再読み込みしてください。',
      'pages.mars.title': '火星',
      'pages.mars.loading': '火星を読み込み中...',
      'pages.venus.title': '金星',
      'pages.venus.info': '金星・厚い大気に包まれた橙色の惑星',
      'pages.jupiter.title': '木星',
      'pages.jupiter.info': '木星',
      'pages.saturn.title': '土星',
      'pages.saturn.info': '土星',
      'pages.uranus.title': '天王星',
      'pages.uranus.info': '天王星・淡い青緑の光をまとった冷たい氷惑星',
      'pages.neptune.title': '海王星',
      'pages.neptune.info': '海王星・深い青がゆっくり流れる氷惑星',
    ...
    'zh-CN': {
      ...
      'home.uranus.title': '天王星发呆',
      'home.uranus.desc': '带着淡青绿色微光的寒冷冰巨星',
      'home.neptune.title': '海王星发呆',
      'home.neptune.desc': '深蓝色缓缓流动的冰巨星',
      ...
      'pages.venus.title': '金星',
      'pages.venus.info': '金星 · 厚重大气包裹下的橙色行星',
      'pages.jupiter.title': '木星',
      'pages.jupiter.info': '木星',
      'pages.saturn.title': '土星',
      'pages.saturn.info': '土星',
      'pages.uranus.title': '天王星',
      'pages.uranus.info': '天王星 · 带着淡青绿色微光的寒冷冰巨星',
      'pages.neptune.title': '海王星',
      'pages.neptune.info': '海王星 · 深蓝色缓缓流动的冰巨星',
    ...
    es: {
      ...
      'home.uranus.title': 'Urano',
      'home.uranus.desc': 'Un gigante helado frio con un brillo turquesa palido',
      'home.neptune.title': 'Neptuno',
      'home.neptune.desc': 'Un gigante helado azul profundo con tonos lentos',
      ...
      'pages.venus.title': 'Venus',
      'pages.venus.info': 'Venus · Un planeta naranja bajo una atmósfera densa',
      'pages.jupiter.title': 'Júpiter',
      'pages.jupiter.info': 'Júpiter',
      'pages.saturn.title': 'Saturno',
      'pages.saturn.info': 'Saturno',
      'pages.uranus.title': 'Urano',
      'pages.uranus.info': 'Urano · Un gigante helado frio con un brillo turquesa palido',
      'pages.neptune.title': 'Neptuno',
      'pages.neptune.info': 'Neptuno · Un gigante helado azul profundo con tonos lentos',
